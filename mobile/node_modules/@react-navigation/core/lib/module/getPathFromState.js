  ...
  while (current) {
    ...
    while (route.name in currentOptions && hasNext) {
      ...
      if (route.params) {
        ...
        currentParams = fromEntries(Object.entries(route.params).map(([key, value]) => [key, (stringify === null || stringify === void 0 ? void 0 : stringify[key]) ? stringify[key](value) : String(value)]));
