...
const CreatePoint = () =>{
//ESTADO: server para guardar informação dentro do componente.

//sempre que criamos um estado para um objeto ou um array precisamos manualemente informar o tipo da variavél.
                    ...
                    <fieldset>
                        ...
                        <ul className="items-grid">
                            {items.map(item => 
                             ...
                             <li key={item.id} onClick={() => handleSelectItem(item.id)} className={
